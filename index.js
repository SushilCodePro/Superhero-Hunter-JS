...
function displayCharList(chars){
    ...
    for(let idx = 0 ; idx < chars.length ; idx++){
        ...
        redirectLink.href = "Discription/charDetails.html?character=" + chars[idx].id;
        ...
        <div class="search-item-info"> 
            <a href = ${"Discription/charDetails.html?character=" + chars[idx].id }> <h3>${chars[idx].name}</h3> </a>
...
function addtoFavs(charDetails){
  ...
  localStorage.setItem('favHeroStore', JSON.stringify(favs));
//   localStorage.setItem('favHeroStore', favs.join(','));
   // console.log(charDetails);
}
